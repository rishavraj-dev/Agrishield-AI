...
Usage:
    cd ai
    python -m training.crop_health.train [--epochs 5] [--batch-size 32] [--device cuda]
...
# ── Dataset with Custom Subset Transforms ─────────────────────────────────────
...
def main():
    parser = argparse.ArgumentParser(description="AgriShield Crop Health Model Training")
    ...
    print(f"============================================================")
    print(f" AgriShield — Crop Health Model Training")
    print(f"============================================================")
    ...
    print(f"[INFO] Total images available: {len(full_dataset)}")
    ...
    train_ds = TransformSubset(full_dataset, train_indices, transform=train_tf)
    val_ds   = TransformSubset(full_dataset, val_indices, transform=val_tf)

    print(f"[INFO] Training set size: {len(train_ds)} | Validation set size: {len(val_ds)}")
